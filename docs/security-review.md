...
- At the owner’s request, the YouTube background again loads automatically and plays muted, respecting reduced-motion and data-saving preferences. This supersedes the reviewed click-to-load behavior below. The footer now discloses the automatic third-party connection. Fonts and artwork are served locally. No application analytics, accounts, payment collection or advertising SDK was found.
